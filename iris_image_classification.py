...
import pandas as pd
df = pd.read_csv('/content/drive/MyDrive/Iris.csv')   #loading the dataset which downloaded from given datasets
df
...
img=mpimg.imread('/content/drive/MyDrive/iris_types.jpg')  #accessing the images of various flowers with different petals and sepals
